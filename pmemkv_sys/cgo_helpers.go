...
func (x KVAllFunction) PassRef() (ref *C.KVAllFunction, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if kVAllFunctionB6C66C05Func == nil {
		kVAllFunctionB6C66C05Func = x
	}
	return (*C.KVAllFunction)(C.KVAllFunction_b6c66c05), nil
}

func NewKVAllFunctionRef(ref unsafe.Pointer) *KVAllFunction {
	return (*KVAllFunction)(ref)
}

//export kVAllFunctionB6C66C05
func kVAllFunctionB6C66C05(ckeybytes C.int, ckey *C.char) {
	if kVAllFunctionB6C66C05Func != nil {
		keybytesb6c66c05 := (int32)(ckeybytes)
		keyb6c66c05 := packPCharString(ckey)
		kVAllFunctionB6C66C05Func(keybytesb6c66c05, keyb6c66c05)
		return
	}
	panic("callback func has not been set (race?)")
}

var kVAllFunctionB6C66C05Func KVAllFunction
...
func (x KVEachFunction) PassRef() (ref *C.KVEachFunction, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if kVEachFunctionC45EE3A2Func == nil {
		kVEachFunctionC45EE3A2Func = x
	}
	return (*C.KVEachFunction)(C.KVEachFunction_c45ee3a2), nil
}

func NewKVEachFunctionRef(ref unsafe.Pointer) *KVEachFunction {
	return (*KVEachFunction)(ref)
}

//export kVEachFunctionC45EE3A2
func kVEachFunctionC45EE3A2(ckeybytes C.int, ckey *C.char, cvaluebytes C.int, cvalue *C.char) {
	if kVEachFunctionC45EE3A2Func != nil {
		keybytesc45ee3a2 := (int32)(ckeybytes)
		keyc45ee3a2 := packPCharString(ckey)
		valuebytesc45ee3a2 := (int32)(cvaluebytes)
		valuec45ee3a2 := packPCharString(cvalue)
		kVEachFunctionC45EE3A2Func(keybytesc45ee3a2, keyc45ee3a2, valuebytesc45ee3a2, valuec45ee3a2)
		return
	}
	panic("callback func has not been set (race?)")
}

var kVEachFunctionC45EE3A2Func KVEachFunction
...
func (x KVGetFunction) PassRef() (ref *C.KVGetFunction, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if kVGetFunctionB57E6DE5Func == nil {
		kVGetFunctionB57E6DE5Func = x
	}
	return (*C.KVGetFunction)(C.KVGetFunction_b57e6de5), nil
}

func NewKVGetFunctionRef(ref unsafe.Pointer) *KVGetFunction {
	return (*KVGetFunction)(ref)
}

//export kVGetFunctionB57E6DE5
func kVGetFunctionB57E6DE5(cvaluebytes C.int, cvalue *C.char) {
	if kVGetFunctionB57E6DE5Func != nil {
		valuebytesb57e6de5 := (int32)(cvaluebytes)
		valueb57e6de5 := packPCharString(cvalue)
		kVGetFunctionB57E6DE5Func(valuebytesb57e6de5, valueb57e6de5)
		return
	}
	panic("callback func has not been set (race?)")
}

var kVGetFunctionB57E6DE5Func KVGetFunction
