...
func Kvengine_exists(kv *KVEngineSys, kb int32, k string) int8 {
	ckv, _ := (*C.KVEngine)(unsafe.Pointer(kv)), cgoAllocsUnknown
	ckb, _ := (C.int32_t)(kb), cgoAllocsUnknown
	ck, _ := unpackPCharString(k)
...
func Kvengine_get_copy(kv *KVEngineSys, kb int32, k string, maxvaluebytes int32, value []byte) int8 {
	ckv, _ := (*C.KVEngine)(unsafe.Pointer(kv)), cgoAllocsUnknown
	ckb, _ := (C.int32_t)(kb), cgoAllocsUnknown
	ck, _ := unpackPCharString(k)
...
func Kvengine_put(kv *KVEngineSys, kb int32, k string, vb int32, v string) int8 {
	ckv, _ := (*C.KVEngine)(unsafe.Pointer(kv)), cgoAllocsUnknown
	ckb, _ := (C.int32_t)(kb), cgoAllocsUnknown
	ck, _ := unpackPCharString(k)
...
func Kvengine_remove(kv *KVEngineSys, kb int32, k string) int8 {
	ckv, _ := (*C.KVEngine)(unsafe.Pointer(kv)), cgoAllocsUnknown
	ckb, _ := (C.int32_t)(kb), cgoAllocsUnknown
	ck, _ := unpackPCharString(k)
